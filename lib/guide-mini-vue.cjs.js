...
function createRenderer(options) {
    ...
    function patchChildren(n1, n2, container, parentComponent, anchor) {
        ...
        if (shapeFlag & 4 /* ShapeFlags.TEXT_CHILDREN */) {
            //牢大是Array_CHILDREN
            if (prevShageFlag & 8 /* ShapeFlags.ARRAY_CHILDREN */) {
                // 把牢大清空
            ...
            //新的是Array_CHILDREN
            // 牢大是Text_CHILDREN
            if (prevShageFlag & 4 /* ShapeFlags.TEXT_CHILDREN */) {
    ...
    function mountComponent(initialVNode, container, parentComponent, anchor) {
        const instance = (initialVNode.component = createComponentInstance(initialVNode, parentComponent)); //{vnode}实例
